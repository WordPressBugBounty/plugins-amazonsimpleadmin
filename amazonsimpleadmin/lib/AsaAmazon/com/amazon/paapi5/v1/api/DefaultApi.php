 ...
 */
namespace AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\api;

use AsaGuzzleHttp\ClientInterface;
use AsaGuzzleHttp\Exception\RequestException;
use AsaGuzzleHttp\Psr7\MultipartStream;
use AsaGuzzleHttp\Psr7\Request;
...
use AsaAmazon\ProductAdvertisingAPI\v1\HeaderSelector;
use AsaAmazon\ProductAdvertisingAPI\v1\ObjectSerializer;
use AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SignHelper;
use http\Exception;
...
class DefaultApi
{
     ...
     *
     * @param  \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesRequest $getBrowseNodesRequest GetBrowseNodesRequest (required)
     *
     * @throws \AsaAmazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesResponse
     */
     ...
     * @throws \AsaAmazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getBrowseNodesWithHttpInfo($getBrowseNodesRequest)
    {
        $returnType = '\AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetBrowseNodesResponse';
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $responseBody,
                        '\AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\ProductAdvertisingAPIClientException',
                ...
                default:
                    $data = ObjectSerializer::deserialize(
                        $responseBody,
                        '\AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\ProductAdvertisingAPIServiceException',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @throws \InvalidArgumentException
     * @return \AsaGuzzleHttp\Promise\PromiseInterface
     */
     ...
     *
     * @throws \InvalidArgumentException
     * @return \AsaGuzzleHttp\Psr7\Request
     */
    protected function getBrowseNodesRequest($getBrowseNodesRequest)
    {
        ...
        if (isset($_tempBody)) {
            ...
            if ($httpBody instanceof \stdClass && $headers['Content-Type'] === 'application/json') {
                $httpBody = \AsaGuzzleHttp\json_encode($httpBody);
            }
            ...
            if ($multipart) {
                ...
                $httpBody = \AsaGuzzleHttp\json_encode($formParams);

            } else {
                // for HTTP post (form)
                $httpBody = \AsaGuzzleHttp\Psr7\build_query($formParams);
            }
        }
        ...
        $query = \AsaGuzzleHttp\Psr7\build_query($queryParams);
        return new Request(
            'POST',
     ...
     * Operation getItems
     *
     * @param  \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsRequest $getItemsRequest GetItemsRequest (required)
     *
     * @throws \AsaAmazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsResponse
     */
     ...
     * @throws \AsaAmazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemsWithHttpInfo($getItemsRequest)
    {
        $returnType = '\AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetItemsResponse';
     ...
     *
     * @param  \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsRequest $getVariationsRequest GetVariationsRequest (required)
     *
     * @throws \AsaAmazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsResponse
     */
     ...
     * @throws \AsaAmazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVariationsWithHttpInfo($getVariationsRequest)
    {
        $returnType = '\AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\GetVariationsResponse';
     ...
     *
     * @param  \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsRequest $searchItemsRequest SearchItemsRequest (required)
     *
     * @throws \AsaAmazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsResponse
     */
     ...
     * @throws \AsaAmazon\ProductAdvertisingAPI\v1\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchItemsWithHttpInfo($searchItemsRequest)
    {
        $returnType = '\AsaAmazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsResponse';
