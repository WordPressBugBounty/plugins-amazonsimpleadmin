...
use AsaGuzzleHttp\HandlerStack;
...
class MockHandler implements \Countable
{
    ...
    public function __invoke(RequestInterface $request, array $options)
    {
        ...
        $response = $response instanceof \Exception
            ? \AsaGuzzleHttp\Promise\rejection_for($response)
            : \AsaGuzzleHttp\Promise\promise_for($response);
        ...
        return $response->then(
            ...
            function ($reason) use ($request, $options) {
                ...
                return \AsaGuzzleHttp\Promise\rejection_for($reason);
            }
        );
    }
        ...
        foreach (func_get_args() as $value) {
            if ($value instanceof ResponseInterface
                ...
                throw new \InvalidArgumentException('Expected a response or '
                    . 'exception. Found ' . \AsaGuzzleHttp\describe_type($value));
            }
        }
    }
